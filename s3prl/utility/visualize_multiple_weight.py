...
parser.add_argument('-s', '--scale', type=float, help='scale the weights', default=1.0, required=False)
...
if ifeaturizer1 := ckpt.get('iFeaturizer1'):
    weights1 = ifeaturizer1['weights'].double() * args.scale
...
if ifeaturizer2 := ckpt.get('iFeaturizer2'):
    weights2 = ifeaturizer2['weights'].double() * args.scale
